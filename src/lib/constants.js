export const LABELS = {
  client: { name: "Client", color: "#f59e0b" },
  capital: { name: "Capital", color: "#8b5cf6" },
  operations: { name: "Operations", color: "#06b6d4" },
  ...
  partnerships: { name: "Partnerships", color: "#3b82f6" },
  strategy: { name: "Strategy", color: "#a855f7" },
